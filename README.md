...
| `reddit-subreddit-scan` | **FEED** what appeared recently in one known subreddit, with bounded chronological coverage? |
...
Known subreddit + bounded recent window -> reddit-subreddit-scan
```
...
`reddit-subreddit-scan` is deliberately narrower: it scans one known public subreddit chronologically over a defined recent window and reports coverage. It is not a replacement for cross-Reddit search or pain research.
